...
export const RELAYER_ADDRESSES: string[] = [];
...
export const CONTRACT_CONFIGS = [
  {
    ...
    events: {
      business: ["Filled"],
      security: ["Upgraded", "OwnershipTransferred", "Transfer", "Withdrawal", "RelayerSet", "Withdrawn", "Approved"]
    }
  },
  {
    name: "originModule", 
  ...
  },
  {
    ...
    events: {
      business: ["Claimed", "Filled", "FillRouteAdded", "ClaimRouteAdded"],
      security: ["Upgraded", "OwnershipTransferred", "Transfer", "Withdrawal", "RelayerSet", "Withdrawn", "Approved"]
    }
  }
] as const;
...
export const SECURITY_EVENT_HANDLERS = {
  ...
  OwnershipTransferred: "handleOwnershipTransfer", 
  Transfer: "handleLargeTransfer",
...
// Contract address mapping for easy lookup
export const CONTRACT_ADDRESS_MAP = {
  [RS_SPOKE_POOL_ADDRESS.toLowerCase()]: "rsSpokePool",
  [ORIGIN_MODULE_ADDRESS.toLowerCase()]: "originModule", 
  [SAME_CHAIN_MODULE_ADDRESS.toLowerCase()]: "sameChainModule",
...
// Large transfer thresholds by chain (in wei/smallest unit)
export const LARGE_TRANSFER_THRESHOLDS: Record<number, bigint> = {
  1: BigInt(10) * BigInt(10 ** 18), // 10 ETH on mainnet
  8453: BigInt(10) * BigInt(10 ** 18), // 10 ETH on Base
  10: BigInt(10) * BigInt(10 ** 18), // 10 ETH on Optimism
  42161: BigInt(10) * BigInt(10 ** 18), // 10 ETH on Arbitrum
  137: BigInt(50000) * BigInt(10 ** 18), // 50,000 MATIC on Polygon
  324: BigInt(10) * BigInt(10 ** 18), // 10 ETH on zkSync
  1868: BigInt(10) * BigInt(10 ** 18), // 10 ETH on Soneium
};
